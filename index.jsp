...
<main class="wrapper" style="background-color: white;">
  <section class="hero" style="background-color: white;">
    <h1 style="color:red;">Famous Places</h1>
    <article>
      <p style="color:red;">&nbsp &nbsp<b>Explore local breweries with just one click and stirred by starlight across the centuries light years great turbulent clouds circumnavigated paroxysm of global death.<b></p>
    ...
    <ul style="background-color: white;">
      <li style="background-color: white;">
        <figure>
          ...
          <figcaption><h3>Ghazipur, Utar Pradesh</h3></figcaption>
        </figure>
        <p>
